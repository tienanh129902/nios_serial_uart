// serial_uart_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module serial_uart_mm_interconnect_0 (
	...
	wire  [14:0] uart_s1_agent_m0_address;                                                           // uart_s1_agent:m0_address -> uart_s1_translator:uav_address
	...
	wire  [89:0] uart_s1_agent_rf_source_data;                                                       // uart_s1_agent:rf_source_data -> uart_s1_agent_rsp_fifo:in_data
	...
	wire  [89:0] uart_s1_agent_rsp_fifo_out_data;                                                    // uart_s1_agent_rsp_fifo:out_data -> uart_s1_agent:rf_sink_data
	...
	wire  [88:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> uart_s1_agent:cp_data
	...
	wire  [88:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> led_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // led_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [3:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> led_s1_agent:cp_channel
	...
	wire  [88:0] uart_s1_agent_rp_data;                                                              // uart_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [88:0] led_s1_agent_rp_data;                                                               // led_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [88:0] router_src_data;                                                                    // router:src_data -> nios2_gen2_0_data_master_limiter:cmd_sink_data
	...
	wire  [88:0] nios2_gen2_0_data_master_limiter_cmd_src_data;                                      // nios2_gen2_0_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [88:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> nios2_gen2_0_data_master_limiter:rsp_sink_data
	...
	wire  [88:0] nios2_gen2_0_data_master_limiter_rsp_src_data;                                      // nios2_gen2_0_data_master_limiter:rsp_src_data -> nios2_gen2_0_data_master_agent:rp_data
	...
	wire  [88:0] router_001_src_data;                                                                // router_001:src_data -> nios2_gen2_0_instruction_master_limiter:cmd_sink_data
	...
	wire  [88:0] nios2_gen2_0_instruction_master_limiter_cmd_src_data;                               // nios2_gen2_0_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [88:0] rsp_mux_001_src_data;                                                               // rsp_mux_001:src_data -> nios2_gen2_0_instruction_master_limiter:rsp_sink_data
	...
	wire  [88:0] nios2_gen2_0_instruction_master_limiter_rsp_src_data;                               // nios2_gen2_0_instruction_master_limiter:rsp_src_data -> nios2_gen2_0_instruction_master_agent:rp_data
	...
	serial_uart_mm_interconnect_0_router router (
	...
	serial_uart_mm_interconnect_0_router_001 router_001 (
	...
	serial_uart_mm_interconnect_0_router_002 router_002 (
	...
	serial_uart_mm_interconnect_0_router_002 router_003 (
	...
	serial_uart_mm_interconnect_0_router_004 router_004 (
	...
	serial_uart_mm_interconnect_0_router_004 router_005 (
	...
	serial_uart_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_clk_clk),                                            //        clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	serial_uart_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_clk_clk),                                                   //        clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	serial_uart_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	serial_uart_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	serial_uart_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	serial_uart_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	serial_uart_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	serial_uart_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	serial_uart_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	serial_uart_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	serial_uart_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	serial_uart_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	serial_uart_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
