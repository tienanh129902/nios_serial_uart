...
module serial_uart_mm_interconnect_0_router_default_decode
  #(
...
module serial_uart_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    serial_uart_mm_interconnect_0_router_default_decode the_default_decode(
